...
accelerate launch --config_file dp_config.yaml infer_and_eval_main_generate.py \
    --index dpo_beta001  \
    --stage 1 > /home/wxt/huatong/TRL_FT/test_code/PRO/eval_hh/logs/generate_infer_main_dpo_beta001.log 2>&1 
    

accelerate launch --config_file dp_config.yaml infer_and_eval_main_reward.py \
    --index dpo_beta001 \
    --stage 1 > /home/wxt/huatong/TRL_FT/test_code/PRO/eval_hh/logs/reward_infer_main_dpo_beta001.log 2>&1

python -u infer_and_eval_main_score.py \
    --index dpo_beta001 \
    --stage 1 > /home/wxt/huatong/TRL_FT/test_code/PRO/eval_hh/logs/score_infer_main_dpo_beta001.log 2>&1
